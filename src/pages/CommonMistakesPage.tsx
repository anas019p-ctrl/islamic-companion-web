  ...
  },
  {
    ...
    mistakes: [
      ...
      },
      {
        ...
        descriptionAr: 'عدم قول "سبحان ربي العظيم" في الركوع أو "سبحان ربي الأعلى" في السجود.',
  ...
  },
  {
    ...
    mistakes: [
      ...
      },
      {
        ...
        correctionAr: 'الحركة الكثيرة لغير ضرورة تبطل الصلاة لأنها تنافي الخشوع.',
      ...
      <main className="container mx-auto px-4 py-8 pt-24 max-w-4xl">
        ...
        >
          ...
          <p className="text-slate-700 dark:text-slate-300 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
            {isArabic ? 'دليلك للتعلم من الأخطاء الشائعة في العبادات اليومية بناءً على السنة النبوية الشريفة.' : 'Un percorso di formazione per correggere la pratica e avvicinarsi alla guida del Profeta ﷺ attraverso lo studio di Arkan e Wajibat.'}
          </p>
